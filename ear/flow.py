...
SENS = {
    ...
    # phonétique - sons universels
    "ka": ("force", "action", "qi"),
    "ma": ("mère", "matière", "origine"),
    "pa": ("père", "protection", "pouvoir"),
    "ta": ("temps", "toucher", "terre"),
    "na": ("nom", "néant", "naissance"),
    "sa": ("souffle", "savoir", "sacré"),
    "ra": ("lumière", "rayon", "roi"),
    "la": ("lune", "liquide", "lien"),
    "va": ("vent", "vie", "vérité"),
    "ya": ("union", "yoga", "yang"),
    "ha": ("souffle", "haut", "harmonie"),
    "om": ("tout", "origine", "un"),
    "ah": ("ouvert", "accepter", "alpha"),
    "oh": ("cercle", "omega", "origine"),
    "ee": ("être", "énergie", "esprit"),
    "oo": ("lune", "eau", "profond"),
    "sh": ("silence", "secret", "shin"),
    "ch": ("change", "chemin", "chi"),
    "ng": ("vibration", "gong", "ring"),
    "th": ("pensée", "theta", "breath"),
    "ph": ("phi", "lumière", "photo"),
    "ps": ("psyche", "psi", "âme"),
    "kh": ("souffle", "khan", "esprit"),
    "gh": ("ombre", "ghost", "profond"),
    "zh": ("vision", "zhao", "lumière"),
    "dh": ("dharma", "loi", "vérité"),
    "bh": ("être", "bhava", "devenir"),
    "jn": ("connaissance", "jnana", "gnose"),
    "aum": ("tout", "création", "trinity"),
    "hum": ("essence", "mantra", "vibration"),
    "ram": ("feu", "énergie", "force"),
    "yam": ("air", "contrôle", "vent"),
    "lam": ("terre", "base", "racine"),
    "vam": ("eau", "flux", "émotion"),
    "ham": ("espace", "éther", "vide"),
}
